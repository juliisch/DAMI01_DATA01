...
for path in [INPUT_ORIGIN_PATH, INPUT_PATH, OUTPUT_PATH]:
    path.mkdir(parents=True, exist_ok=True)

# Quelle: OpenAI. (2026a). Antwort von ChatGPT
# auf eine Anfrage zu Erstellung einer Kategorien-Dictionary
# der Variable description. Anhang C.
MAP_DESCRIPTION = {
    "Food_and_Beverage": [
...
# Quelle: OpenAI. (2026b). Antwort von ChatGPT
# auf eine Anfrage zu Erstellung einer Kategorien-Dictionary
# der Variable merchant_state. Anhang B.
MAP_MERCHANT_STATE = {
    "US_States": [
        "ND", "IA", "CA", "IN", "MD", "NY", "TX", "HI", "PA", "WI",
        "GA", "AL", "CT", "WA", "MA", "CO", "NJ", "OK", "MT", "FL",
        "AZ", "KY", "LA", "IL", "OH", "MO", "MI", "KS", "NC", "AR",
        "TN", "NM", "SC", "MN", "NV", "OR", "VA", "SD", "WV", "ME",
        "MS", "RI", "NH", "DE", "VT", "ID", "NE", "DC", "UT", "WY",
        "AK", "AA",
    ],
    "North_America": [
        "Mexico", "Canada", "Costa Rica", "Dominican Republic",
        "Guatemala", "Honduras", "Belize", "Panama", "Jamaica",
        "The Bahamas", "Barbados", "Aruba", "Antigua and Barbuda",
        "Saint Vincent and the Grenadines", "Trinidad and Tobago",
        "Haiti",
    ],
    "South_America": [
        "Colombia", "Brazil", "Peru", "Chile", "Argentina", "Uruguay",
        "Ecuador", "Suriname", "Venezuela", "Guyana",
    ],
    "Europe": [
        "Germany", "United Kingdom", "Estonia", "Lithuania",
        "Netherlands", "Greece", "Ireland", "France", "Italy",
        "Denmark", "Belgium", "Switzerland", "Portugal", "Finland",
        "Norway", "Hungary", "Israel", "Monaco", "Romania", "Russia",
        "Austria", "Spain", "Moldova", "Croatia", "Sweden", "Andorra",
        "Czech Republic", "Macedonia", "Turkey", "Luxembourg",
        "Slovakia", "Ukraine", "Montenegro", "Iceland", "Slovenia",
        "Latvia", "Poland", "Georgia", "Cyprus", "Serbia", "Kosovo",
        "Bosnia and Herzegovina", "Malta", "Albania", "Vatican City",
        "Azerbaijan",
    ],
    "Asia": [
        "China", "Taiwan", "United Arab Emirates", "Japan", "Vietnam",
        "Singapore", "Thailand", "Indonesia", "Philippines",
        "Saudi Arabia", "South Korea", "India", "Mongolia",
        "Hong Kong", "Bangladesh", "Uzbekistan", "Brunei", "Pakistan",
        "Oman", "Bahrain", "Malaysia", "Myanmar (Burma)", "Iran",
        "Lebanon", "Iraq", "Jordan", "Yemen", "Qatar", "Maldives",
        "Kyrgyzstan", "Sri Lanka", "East Timor (Timor-Leste)",
    ],
    "Africa": [
        ...
        "Equatorial Guinea", "Ethiopia", "Swaziland", "Mozambique",
        "Zambia", "Liberia", "Mali", "Senegal", "Gabon", "Tunisia",
        "Seychelles", "Cote d'Ivoire", "Guinea", "Morocco",
        "Sudan", "Republic of the Congo",
    ],
    "Oceania": [
        "New Zealand", "Australia", "Tuvalu", "Marshall Islands",
        "Micronesia", "Tonga", "Solomon Islands", "Fiji", "Nauru",
        "Vanuatu", "Samoa", "Papua New Guinea",
    ],
}

# Quelle: OpenAI. (2026c). Antwort von ChatGPT auf
# eine Anfrage zu Erstellung einer Kategorien-Dictionary
# der Variable error_category. Anhang D.
MAP_ERROR_CATEGORY = {
    "No_Error": [
        'None'
    ],
